...
public class Spawner<T> : ComponentBehavior
{
    private static Spawner<T> instance;
    ...
    public static Spawner<T> Instance => instance;
    protected override void Awake()
    {
       if(instance != null)
           Debug.LogError("Only one Spawner allow to exist");
       instance = this;
    }
